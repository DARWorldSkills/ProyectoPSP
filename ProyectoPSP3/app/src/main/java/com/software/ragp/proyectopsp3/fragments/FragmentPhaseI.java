 ...
 */
public class FragmentPhaseI extends Fragment {


    public FragmentPhaseI() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_phase_i, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.recyclerDI);
